...
#ifndef FIRMWARE_FW_REGS_H_
#define FIRMWARE_FW_REGS_H_
#include <stdint.h>
...
//-----------------------------------------------------------------------------
	...
	//0x40010000UL : Registro de recepcion de la UART2:
	...
	#define     U2FCR		DIR_UART2[2]
	#define		U2LCR		DIR_UART2[3]
	#define		U2LSR		DIR_UART2[5]
	#define     U2SCR       DIR_UART2[7]
	#define     U2ACR       DIR_UART2[8]
	#define     U2ICR       DIR_UART2[9]
	#define     U2FDR	    DIR_UART2[10]
	#define     U2TER		DIR_UART2[12]


#endif /* FIRMWARE_FW_REGS_H_ */
